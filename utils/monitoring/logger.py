# flaskllm/utils/monitoring/logger.py
"""
...
class UtilsLogger:
    ...
    This class provides a unified interface for logging with structured data,
    configurable formatting, and integration with monitoring systems.
    """
    ...
    def __init__(self, name: str, level: int = logging.INFO):
        ...
        Args:
            ...
            level: Logging level
        """
        self.logger = get_structured_logger(name, level)
    ...
    @staticmethod
    def configure_app(app, level: int = logging.INFO) -> None:
        """Configure logging for a Flask application."""
        configure_app_logging(app, level)
