# flaskllm/core/user_settings_storage.py
"""
...
class UserSettingsStorage:
    ...
    def save_settings(self, settings: UserSettings) -> None:
        ...
        Raises:
            SettingsError: If settings could not be saved to file
        """
        # Update in memory
        ...
        if self.storage_dir:
            try:
                ...
                raise SettingsError(f"Could not save settings: {str(e)}")
    ...
    def delete_settings(self, user_id: str) -> bool:
        ...
        Raises:
            SettingsError: If settings could not be deleted from file
        """
        # Remove from memory
        if user_id in self.settings:
        ...
        if self.storage_dir:
            ...
            if os.path.exists(file_path):
                try:
                    ...
                    raise SettingsError(f"Could not delete settings: {str(e)}")
    ...
    def _load_settings(self, user_id: str) -> None:
        ...
        try:
            ...
            raise SettingsError(f"Settings file contains invalid JSON: {str(e)}") 
        except Exception as e:
