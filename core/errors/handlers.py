...
from flask import Flask, jsonify, Response, current_app, request
from pydantic import ValidationError

from ..exceptions import APIError, AuthenticationError, ValidationError as AppValidationError
...
def format_error_response(
    ...
    """
    error_info = ErrorCodes.get_error_details(error_code, message)
