...
This module defines Pydantic schemas for request and response validation. It provides
model classes for input validation, error handling, and response formatting that are
used across the API endpoints.

The schemas ensure consistent data structures and validation rules throughout the API,
and are integrated with Swagger documentation via flask_restx to provide automatic
API documentation.
"""
import re
